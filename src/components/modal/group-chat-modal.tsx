...
import UserBadgeItem from "../chats/user-badge-item";
import UserListItem from "../chats/user-list-item";
...
const GroupChatModal = ({ children }: { children: ReactNode }) => {
  ...
  const handleDelete = (delUser: { _id: any }) => {
    setSelectedUsers(
